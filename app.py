...
# all output of transformer should be dataframe
...
airline = st.selectbox(
	"Airline:",
	options= sorted(X_train.airline.unique())
...
source = st.selectbox(
	"Source",
	options=sorted(X_train.source.unique())
)

destination = st.selectbox(
	"Destination",
	options=sorted(X_train.destination.unique(), reverse= True)
)
